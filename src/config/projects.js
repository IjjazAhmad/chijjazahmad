...
export const projects = [
  ...
  [
    {
      title: "Ummaah Dashboard - Main Admin Panel",
      description:
        "I developed this comprehensive mosque management dashboard using React.js and modern CSS frameworks. It's a full-stack application featuring member management, prayer time scheduling, donation tracking, event organization, and administrative oversight for mosque operations.",
      img: rafiq_5,
      category: "Mosque Management",
    },
    {
      title: "Ummaah Dashboard - Prayer Management System",
      description:
        "Advanced prayer management interface with automated prayer time calculations, imam scheduling, congregation tracking, and announcement systems. Built with responsive design to support mosque administrators in managing daily prayer activities.",
      img: rafiq_2,
      category: "Mosque Management",
    },
    {
      title: "Ummaah Dashboard - Donation & Finance Tracker",
      description:
        "Comprehensive financial management system featuring donation tracking, expense monitoring, budget planning, and financial reporting tools. Provides mosque administrators with complete oversight of financial operations and transparency.",
      img: rafiq_3,
      category: "Mosque Management",
    },
    {
      title: "Ummaah Dashboard - Member & Community Portal",
      description:
  ...
  [
    {
      title: "URL Shortener - Main Dashboard",
      description:
        "I developed this comprehensive URL shortening platform using React.js and modern web technologies. It's a full-stack application featuring link management, analytics tracking, custom aliases, QR code generation, and user authentication for professional URL shortening services.",
      img: URLShortner_1,
      category: "Web Application",
    },
    {
      title: "URL Shortener - Analytics & Tracking System",
      description:
